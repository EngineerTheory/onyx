...
$COMPOSE_CMD -f docker-compose.prod.yml run  --name recap-stack --rm --entrypoint "\
...
echo "### Starting nginx ..."
$COMPOSE_CMD -f docker-compose.prod.yml -p recap-stack up --force-recreate -d nginx
echo
...
$COMPOSE_CMD -f docker-compose.prod.yml -p recap-stack up --force-recreate -d
