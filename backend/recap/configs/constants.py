...
NO_AUTH_USER_EMAIL = "anonymous@recap.work"
...
DANSWER_METADATA_FILENAME = ".recap_metadata.json"

# Messages
DISABLED_GEN_AI_MSG = (
    "Your System Admin has disabled the Generative AI functionalities of RECAP.\n"
    "Please contact them if you wish to have this enabled.\n"
    "You can still use RECAP as a search engine."
)
...
class MilestoneRecordType(str, Enum):
    ...
    CREATED_RECAP_BOT = "created_recap_bot"
...
class RecapRedisSignals:
    VALIDATE_INDEXING_FENCES = "signal:validate_indexing_fences"


class RecapCeleryPriority(int, Enum):
    HIGHEST = 0
    HIGH = auto()
    MEDIUM = auto()
    LOW = auto()
