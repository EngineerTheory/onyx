...
from recap.connectors.salesforce.doc_conversion import convert_sf_object_to_doc
from recap.connectors.salesforce.doc_conversion import ID_PREFIX
from recap.connectors.salesforce.salesforce_calls import fetch_all_csvs_in_parallel
from recap.connectors.salesforce.salesforce_calls import get_all_children_of_sf_type
...
class SalesforceConnector(LoadConnector, PollConnector, SlimConnector):
    ...
    def _fetch_from_salesforce(
        ...
        # from import recap.connectors.salesforce.sf_db.sqlite_functions find_ids_by_type
