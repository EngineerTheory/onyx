...
from recap.connectors.salesforce.shelve_stuff.shelve_utils import (
    get_child_to_parent_shelf_path,
)
from recap.connectors.salesforce.shelve_stuff.shelve_utils import get_id_type_shelf_path
from recap.connectors.salesforce.shelve_stuff.shelve_utils import get_object_shelf_path
from recap.connectors.salesforce.shelve_stuff.shelve_utils import (
    get_parent_to_child_shelf_path,
)
from recap.connectors.salesforce.utils import SalesforceObject
from recap.connectors.salesforce.utils import validate_salesforce_id
