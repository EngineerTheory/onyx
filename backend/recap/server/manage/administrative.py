...
from recap.configs.app_configs import GENERATIVE_MODEL_ACCESS_CHECK_FREQ
from recap.configs.constants import DocumentSource
from recap.configs.constants import KV_GEN_AI_KEY_CHECK_TIME
...
from recap.db.feedback import fetch_docs_ranked_by_boost
from recap.db.feedback import update_document_boost
from recap.db.feedback import update_document_hidden
from recap.db.index_attempt import cancel_indexing_attempts_for_ccpair
...
from recap.llm.utils import test_llm
from recap.server.documents.models import ConnectorCredentialPairIdentifier
from recap.server.manage.models import BoostDoc
from recap.server.manage.models import BoostUpdateRequest
from recap.server.manage.models import HiddenUpdateRequest
...
def create_deletion_attempt_for_connector_id(
    ...
    primary_app.send_task(
        RecapCeleryTask.CHECK_FOR_CONNECTOR_DELETION,
