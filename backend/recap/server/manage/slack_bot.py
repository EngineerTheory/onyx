...
from recap.db.constants import SLACK_BOT_PERSONA_PREFIX
...
from recap.db.slack_bot import fetch_slack_bot
from recap.db.slack_bot import fetch_slack_bots
from recap.db.slack_bot import insert_slack_bot
from recap.db.slack_bot import remove_slack_bot
from recap.db.slack_bot import update_slack_bot
from recap.db.slack_channel_config import create_slack_channel_persona
from recap.db.slack_channel_config import fetch_slack_channel_config
from recap.db.slack_channel_config import fetch_slack_channel_configs
from recap.db.slack_channel_config import insert_slack_channel_config
from recap.db.slack_channel_config import remove_slack_channel_config
from recap.db.slack_channel_config import update_slack_channel_config
from recap.onyxbot.slack.config import validate_channel_name
from recap.server.manage.models import SlackBot
from recap.server.manage.models import SlackBotCreationRequest
from recap.server.manage.models import SlackChannelConfig
from recap.server.manage.models import SlackChannelConfigCreationRequest
...
def create_bot(
    ...
    create_milestone_and_report(
        ...
        event_type=MilestoneRecordType.CREATED_RECAP_BOT,
        properties=None,
        db_session=db_session,
    )
