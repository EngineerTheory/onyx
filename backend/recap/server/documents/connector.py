...
from recap.auth.users import current_chat_accesssible_user
from recap.auth.users import current_curator_or_admin_user
from recap.auth.users import current_user
from recap.background.celery.celery_utils import get_deletion_attempt_snapshot
from recap.background.celery.versioned_apps.primary import app as primary_app
from recap.configs.app_configs import ENABLED_CONNECTOR_TYPES
from recap.configs.constants import DocumentSource
from recap.configs.constants import FileOrigin
from recap.configs.constants import MilestoneRecordType
from recap.configs.constants import RecapCeleryPriority
from recap.configs.constants import RecapCeleryTask
from recap.connectors.google_utils.google_auth import (
    get_google_oauth_creds,
)
from recap.connectors.google_utils.google_kv import (
...
from recap.connectors.google_utils.google_kv import get_auth_url
from recap.connectors.google_utils.google_kv import (
    get_google_app_cred,
)
from recap.connectors.google_utils.google_kv import (
...
from recap.connectors.google_utils.google_kv import verify_csrf
from recap.connectors.google_utils.shared_constants import (
    DB_CREDENTIALS_DICT_TOKEN_KEY,
)
from recap.db.connector import create_connector
from recap.db.connector import delete_connector
from recap.db.connector import fetch_connector_by_id
from recap.db.connector import fetch_connectors
from recap.db.connector import get_connector_credential_ids
from recap.db.connector import mark_ccpair_with_indexing_trigger
from recap.db.connector import update_connector
from recap.db.connector_credential_pair import add_credential_to_connector
from recap.db.connector_credential_pair import get_cc_pair_groups_for_ids
from recap.db.connector_credential_pair import get_connector_credential_pair
from recap.db.connector_credential_pair import get_connector_credential_pairs
from recap.db.credentials import cleanup_gmail_credentials
from recap.db.credentials import cleanup_google_drive_credentials
from recap.db.credentials import create_credential
from recap.db.credentials import delete_service_account_credentials
from recap.db.credentials import fetch_credential_by_id
from recap.db.deletion_attempt import check_deletion_attempt_is_allowed
from recap.db.document import get_document_counts_for_cc_pairs
from recap.db.engine import get_current_tenant_id
from recap.db.engine import get_session
from recap.db.enums import AccessType
from recap.db.enums import IndexingMode
from recap.db.index_attempt import get_index_attempts_for_cc_pair
from recap.db.index_attempt import get_latest_index_attempt_for_cc_pair_id
from recap.db.index_attempt import get_latest_index_attempts
from recap.db.index_attempt import get_latest_index_attempts_by_status
from recap.db.models import IndexingStatus
from recap.db.models import SearchSettings
from recap.db.models import User
from recap.db.search_settings import get_current_search_settings
from recap.db.search_settings import get_secondary_search_settings
from recap.file_processing.extract_file_text import convert_docx_to_txt
from recap.file_store.file_store import get_default_file_store
from recap.key_value_store.interface import KvKeyNotFoundError
from recap.redis.redis_connector import RedisConnector
from recap.server.documents.models import AuthStatus
from recap.server.documents.models import AuthUrl
...
from recap.server.documents.models import ConnectorSnapshot
from recap.server.documents.models import ConnectorUpdateRequest
from recap.server.documents.models import CredentialBase
from recap.server.documents.models import CredentialSnapshot
from recap.server.documents.models import FailedConnectorIndexingStatus
from recap.server.documents.models import FileUploadResponse
from recap.server.documents.models import GDriveCallback
from recap.server.documents.models import GmailCallback
from recap.server.documents.models import GoogleAppCredentials
from recap.server.documents.models import GoogleServiceAccountCredentialRequest
from recap.server.documents.models import GoogleServiceAccountKey
from recap.server.documents.models import IndexAttemptSnapshot
from recap.server.documents.models import ObjectCreationIdResponse
from recap.server.documents.models import RunConnectorRequest
from recap.server.models import StatusResponse
from recap.utils.logger import setup_logger
from recap.utils.telemetry import create_milestone_and_report
from recap.utils.variable_functionality import fetch_ee_implementation_or_noop
...
def connector_run_once(
    ...
    primary_app.send_task(
        RecapCeleryTask.CHECK_FOR_INDEXING,
        priority=RecapCeleryPriority.HIGH,
