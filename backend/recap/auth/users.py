...
from recap.auth.api_key import get_hashed_api_key_from_request
from recap.auth.email_utils import send_forgot_password_email
from recap.auth.email_utils import send_user_verification_email
from recap.auth.invited_users import get_invited_users
...
from recap.configs.app_configs import DISABLE_AUTH
from recap.configs.app_configs import EMAIL_CONFIGURED
from recap.configs.app_configs import REDIS_AUTH_EXPIRE_TIME_SECONDS
from recap.configs.app_configs import REDIS_AUTH_KEY_PREFIX
from recap.configs.app_configs import REQUIRE_EMAIL_VERIFICATION
from recap.configs.app_configs import SESSION_EXPIRE_TIME_SECONDS
from recap.configs.app_configs import TRACK_EXTERNAL_IDP_EXPIRY
from recap.configs.app_configs import USER_AUTH_SECRET
from recap.configs.app_configs import VALID_EMAIL_DOMAINS
from recap.configs.app_configs import WEB_DOMAIN
from recap.configs.constants import AuthType
from recap.configs.constants import DANSWER_API_KEY_DUMMY_EMAIL_DOMAIN
from recap.configs.constants import DANSWER_API_KEY_PREFIX
from recap.configs.constants import MilestoneRecordType
from recap.configs.constants import RecapRedisLocks
from recap.configs.constants import PASSWORD_SPECIAL_CHARS
from recap.configs.constants import UNNAMED_KEY_PLACEHOLDER
from recap.db.api_key import fetch_user_for_api_key
from recap.db.auth import get_default_admin_user_emails
from recap.db.auth import get_user_count
from recap.db.auth import get_user_db
from recap.db.auth import SQLAlchemyUserAdminDB
from recap.db.engine import get_async_session
from recap.db.engine import get_async_session_with_tenant
from recap.db.engine import get_current_tenant_id
from recap.db.engine import get_session_with_tenant
from recap.db.models import OAuthAccount
from recap.db.models import User
from recap.db.users import get_user_by_email
from recap.redis.redis_pool import get_async_redis_connection
...
def anonymous_user_enabled(*, tenant_id: str | None = None) -> bool:
    ...
    value = redis_client.get(RecapRedisLocks.ANONYMOUS_USER_ENABLED)
