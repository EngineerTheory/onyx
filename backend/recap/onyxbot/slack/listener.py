...
from recap.configs.app_configs import DEV_MODE
from recap.configs.app_configs import POD_NAME
from recap.configs.app_configs import POD_NAMESPACE
from recap.configs.constants import MessageType
from recap.configs.constants import RecapRedisLocks
from recap.configs.onyxbot_configs import DANSWER_BOT_REPHRASE_MESSAGE
from recap.configs.onyxbot_configs import DANSWER_BOT_RESPOND_EVERY_CHANNEL
from recap.configs.onyxbot_configs import NOTIFY_SLACKBOT_NO_ANSWER
from recap.connectors.slack.utils import expert_info_from_slack_id
from recap.context.search.retrieval.search_runner import download_nltk_data
from recap.db.engine import get_all_tenant_ids
from recap.db.engine import get_session_with_tenant
from recap.db.models import SlackBot
from recap.db.search_settings import get_current_search_settings
from recap.db.slack_bot import fetch_slack_bots
from recap.key_value_store.interface import KvKeyNotFoundError
from recap.natural_language_processing.search_nlp_models import EmbeddingModel
from recap.natural_language_processing.search_nlp_models import warm_up_bi_encoder
from recap.onyxbot.slack.config import get_slack_channel_config_for_bot_and_channel
from recap.onyxbot.slack.config import MAX_TENANTS_PER_POD
from recap.onyxbot.slack.config import TENANT_ACQUISITION_INTERVAL
from recap.onyxbot.slack.config import TENANT_HEARTBEAT_EXPIRATION
from recap.onyxbot.slack.config import TENANT_HEARTBEAT_INTERVAL
from recap.onyxbot.slack.config import TENANT_LOCK_EXPIRATION
from recap.onyxbot.slack.constants import DISLIKE_BLOCK_ACTION_ID
from recap.onyxbot.slack.constants import FEEDBACK_DOC_BUTTON_BLOCK_ACTION_ID
from recap.onyxbot.slack.constants import FOLLOWUP_BUTTON_ACTION_ID
from recap.onyxbot.slack.constants import FOLLOWUP_BUTTON_RESOLVED_ACTION_ID
from recap.onyxbot.slack.constants import GENERATE_ANSWER_BUTTON_ACTION_ID
from recap.onyxbot.slack.constants import IMMEDIATE_RESOLVED_BUTTON_ACTION_ID
from recap.onyxbot.slack.constants import LIKE_BLOCK_ACTION_ID
from recap.onyxbot.slack.constants import VIEW_DOC_FEEDBACK_ID
from recap.onyxbot.slack.handlers.handle_buttons import handle_doc_feedback_button
from recap.onyxbot.slack.handlers.handle_buttons import handle_followup_button
from recap.onyxbot.slack.handlers.handle_buttons import (
    handle_followup_resolved_button,
)
from recap.onyxbot.slack.handlers.handle_buttons import (
    handle_generate_answer_button,
)
from recap.onyxbot.slack.handlers.handle_buttons import handle_slack_feedback
from recap.onyxbot.slack.handlers.handle_message import handle_message
from recap.onyxbot.slack.handlers.handle_message import (
    remove_scheduled_feedback_reminder,
)
from recap.onyxbot.slack.handlers.handle_message import schedule_feedback_reminder
from recap.onyxbot.slack.models import SlackMessageInfo
from recap.onyxbot.slack.utils import check_message_limit
from recap.onyxbot.slack.utils import decompose_action_id
from recap.onyxbot.slack.utils import get_channel_name_from_id
from recap.onyxbot.slack.utils import get_onyx_bot_slack_bot_id
from recap.onyxbot.slack.utils import read_slack_thread
from recap.onyxbot.slack.utils import remove_onyx_bot_tag
from recap.onyxbot.slack.utils import rephrase_slack_message
from recap.onyxbot.slack.utils import respond_in_thread
from recap.onyxbot.slack.utils import TenantSocketModeClient
from recap.redis.redis_pool import get_redis_client
from recap.server.manage.models import SlackBotTokens
...
class SlackbotHandler:
    ...
    def acquire_tenants(self) -> None:
        ...
        for tenant_id in tenant_ids:
            ...
            acquired = redis_client.set(
                RecapRedisLocks.SLACK_BOT_LOCK,
                pod_id,
                nx=True,
    ...
    def send_heartbeats(self) -> None:
        ...
        for tenant_id in self.tenant_ids:
            redis_client = get_redis_client(tenant_id=tenant_id)
            heartbeat_key = f"{RecapRedisLocks.SLACK_BOT_HEARTBEAT_PREFIX}:{self.pod_id}"
            redis_client.set(
    ...
    def shutdown(self, signum: int | None, frame: FrameType | None) -> None:
        ...
        for tenant_id in self.tenant_ids:
            try:
                redis_client = get_redis_client(tenant_id=tenant_id)
                redis_client.delete(RecapRedisLocks.SLACK_BOT_LOCK)
