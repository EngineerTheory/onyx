...
from recap.configs.app_configs import CELERY_BROKER_POOL_LIMIT
from recap.configs.app_configs import CELERY_RESULT_EXPIRES
from recap.configs.app_configs import REDIS_DB_NUMBER_CELERY
from recap.configs.app_configs import REDIS_DB_NUMBER_CELERY_RESULT_BACKEND
from recap.configs.app_configs import REDIS_HEALTH_CHECK_INTERVAL
from recap.configs.app_configs import REDIS_HOST
from recap.configs.app_configs import REDIS_PASSWORD
from recap.configs.app_configs import REDIS_PORT
from recap.configs.app_configs import REDIS_SSL
from recap.configs.app_configs import REDIS_SSL_CA_CERTS
from recap.configs.app_configs import REDIS_SSL_CERT_REQS
from recap.configs.constants import RecapCeleryPriority
from recap.configs.constants import REDIS_SOCKET_KEEPALIVE_OPTIONS
...
broker_transport_options = {
    "priority_steps": list(range(len(RecapCeleryPriority))),
...
task_default_priority = RecapCeleryPriority.MEDIUM
task_acks_late = True
