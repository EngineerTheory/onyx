...
import recap.background.celery.apps.app_base as app_base
from recap.background.celery.apps.app_base import task_logger
from recap.background.celery.celery_utils import celery_is_worker_primary
from recap.background.celery.tasks.indexing.tasks import (
    get_unfenced_index_attempt_ids,
)
from recap.configs.constants import CELERY_PRIMARY_WORKER_LOCK_TIMEOUT
from recap.configs.constants import RecapRedisLocks
from recap.configs.constants import POSTGRES_CELERY_WORKER_PRIMARY_APP_NAME
from recap.db.engine import get_session_with_default_tenant
...
from recap.redis.redis_connector_ext_group_sync import RedisConnectorExternalGroupSync
...
from recap.redis.redis_connector_stop import RedisConnectorStop
...
def on_worker_init(sender: Any, **kwargs: Any) -> None:
    ...
    r.delete(RecapRedisLocks.PRIMARY_WORKER)
    ...
    lock: RedisLock = r.lock(
        RecapRedisLocks.PRIMARY_WORKER,
    ...
    r.delete(RecapRedisLocks.CHECK_VESPA_SYNC_BEAT_LOCK)
    r.delete(RecapRedisLocks.MONITOR_VESPA_SYNC_BEAT_LOCK)
