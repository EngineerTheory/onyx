...
from recap.background.celery.apps.task_formatters import CeleryTaskColoredFormatter
from recap.background.celery.apps.task_formatters import CeleryTaskPlainFormatter
...
from recap.document_index.vespa_constants import VESPA_CONFIG_SERVER_URL
...
from recap.utils.logger import ColoredFormatter
from recap.utils.logger import PlainFormatter
...
def on_secondary_worker_init(sender: Any, **kwargs: Any) -> None:
    ...
    while True:
        if r.exists(RecapRedisLocks.PRIMARY_WORKER):
            break
