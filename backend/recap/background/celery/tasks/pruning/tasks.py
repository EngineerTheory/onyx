...
from recap.background.celery.celery_utils import extract_ids_from_runnable_connector
from recap.background.celery.tasks.indexing.tasks import IndexingCallback
from recap.configs.app_configs import ALLOW_SIMULTANEOUS_PRUNING
from recap.configs.app_configs import JOB_TIMEOUT
from recap.configs.constants import CELERY_PRUNING_LOCK_TIMEOUT
...
from recap.db.document import get_documents_for_connector_credential_pair
...
from recap.utils.logger import pruning_ctx
