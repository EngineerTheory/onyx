...
from ee.recap.db.connector_credential_pair import get_all_auto_sync_cc_pairs
from ee.recap.db.connector_credential_pair import get_cc_pairs_by_source
from ee.recap.db.external_perm import ExternalUserGroup
from ee.recap.db.external_perm import replace_user__ext_group_for_cc_pair
from ee.recap.external_permissions.sync_params import EXTERNAL_GROUP_SYNC_PERIODS
from ee.recap.external_permissions.sync_params import GROUP_PERMISSIONS_FUNC_MAP
from ee.recap.external_permissions.sync_params import (
...
from recap.configs.constants import CELERY_EXTERNAL_GROUP_SYNC_LOCK_TIMEOUT
...
from recap.configs.constants import RecapCeleryQueues
from recap.configs.constants import RecapCeleryTask
from recap.configs.constants import RecapRedisLocks
from recap.db.connector import mark_cc_pair_as_external_group_synced
...
from recap.redis.redis_connector_ext_group_sync import (
...
@shared_task(
    name=RecapCeleryTask.CHECK_FOR_EXTERNAL_GROUP_SYNC,
...
def check_for_external_group_sync(self: Task, *, tenant_id: str | None) -> bool | None:
    ...
    lock_beat: RedisLock = r.lock(
        RecapRedisLocks.CHECK_CONNECTOR_EXTERNAL_GROUP_SYNC_BEAT_LOCK,
...
def try_creating_external_group_sync_task(
    ...
    try:
        ...
        result = app.send_task(
            RecapCeleryTask.CONNECTOR_EXTERNAL_GROUP_SYNC_GENERATOR_TASK,
            kwargs=dict(
                cc_pair_id=cc_pair_id,
                tenant_id=tenant_id,
            ),
            queue=RecapCeleryQueues.CONNECTOR_EXTERNAL_GROUP_SYNC,
...
@shared_task(
    name=RecapCeleryTask.CONNECTOR_EXTERNAL_GROUP_SYNC_GENERATOR_TASK,
    acks_late=False,
    soft_time_limit=JOB_TIMEOUT,
    track_started=True,
    trail=False,
...
def connector_external_group_sync_generator_task(
    ...
    lock: RedisLock = r.lock(
        RecapRedisLocks.CONNECTOR_EXTERNAL_GROUP_SYNC_LOCK_PREFIX
