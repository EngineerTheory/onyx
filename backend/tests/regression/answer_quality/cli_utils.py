...
def start_docker_compose(
    ...
    command = f"docker compose -f docker-compose.search-testing.yml -p recap-stack-{env_name} up -d"
    command += " --build"
...
def cleanup_docker(env_name: str) -> None:
    ...
    project_name = f"recap-stack{env_name}"
...
if __name__ == "__main__":
    ...
    If no environment_name is indicated, will just clean up all recap docker containers/volumes/networks
    """
