...
from ee.recap.configs.app_configs import OAUTH_CONFLUENCE_CLIENT_ID
from ee.recap.configs.app_configs import OAUTH_CONFLUENCE_CLIENT_SECRET
from ee.recap.configs.app_configs import OAUTH_GOOGLE_DRIVE_CLIENT_ID
from ee.recap.configs.app_configs import OAUTH_GOOGLE_DRIVE_CLIENT_SECRET
from ee.recap.configs.app_configs import OAUTH_SLACK_CLIENT_ID
from ee.recap.configs.app_configs import OAUTH_SLACK_CLIENT_SECRET
...
from recap.connectors.google_utils.google_auth import get_google_oauth_creds
from recap.connectors.google_utils.google_auth import sanitize_oauth_credentials
...
class SlackOAuth:
    ...
    # SCOPE is per https://docs.recap.work/connectors/slack
    BOT_SCOPE = (
        "channels:history,"
        "channels:read,"
        "groups:history,"
...
class GoogleDriveOAuth:
    ...
    # SCOPE is per https://docs.recap.work/connectors/google-drive
